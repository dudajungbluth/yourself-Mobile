...
public class FragmentAcessories extends Fragment {
    ...
    public FragmentAcessories() {
        // Required empty public constructor
    }

    public static FragmentAcessories newInstance() {
        FragmentAcessories fragment = new FragmentAcessories();
    ...
    public void onResume() {
        ...
        meuAdaptador = new MeuAdaptador(oculos, 3);
